...
function UniqueIdServiceClient:ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier)
  self:send_ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier)
  return self:recv_ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier)
end

function UniqueIdServiceClient:send_ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier)
...
function UniqueIdServiceClient:recv_ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier)
...
function UniqueIdServiceProcessor:process_ComposeUniqueId(seqid, iprot, oprot, server_ctx)
  ...
  iprot:readMessageEnd()
  local result = ComposeUniqueId_result:new{}
  local status, res = pcall(self.handler.ComposeUniqueId, self.handler, args.flow, args.timestamp, args.edge, args.req_id, args.post_type, args.carrier)
  if not status then
...
function ComposeUniqueId_args:write(oprot)
  ...
  if self.post_type ~= nil then
    oprot:writeFieldBegin('post_type', TType.I32, 5)
