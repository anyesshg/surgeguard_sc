...
function HomeTimelineServiceClient:ReadHomeTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier)
  self:send_ReadHomeTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier)
  return self:recv_ReadHomeTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier)
end

function HomeTimelineServiceClient:send_ReadHomeTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier)
...
function HomeTimelineServiceClient:recv_ReadHomeTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier)
...
function HomeTimelineServiceClient:WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier)
  self:send_WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier)
  self:recv_WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier)
end

function HomeTimelineServiceClient:send_WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier)
...
function HomeTimelineServiceClient:recv_WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier)
  local fname, mtype, rseqid = self.iprot:readMessageBegin()
  if mtype == TMessageType.EXCEPTION then
    local x = TApplicationException:new{}
    x:read(self.iprot)
...
function HomeTimelineServiceProcessor:process_ReadHomeTimeline(seqid, iprot, oprot, server_ctx)
  ...
  iprot:readMessageEnd()
  local result = ReadHomeTimeline_result:new{}
  local status, res = pcall(self.handler.ReadHomeTimeline, self.handler, args.flow, args.timestamp2, args.edge, args.req_id, args.user_id, args.start, args.stop, args.carrier)
  if not status then
...
function HomeTimelineServiceProcessor:process_WriteHomeTimeline(seqid, iprot, oprot, server_ctx)
  ...
  iprot:readMessageEnd()
  local result = WriteHomeTimeline_result:new{}
  local status, res = pcall(self.handler.WriteHomeTimeline, self.handler, args.flow, args.timestamp2, args.edge, args.req_id, args.post_id, args.user_id, args.timestamp, args.user_mentions_id, args.carrier)
  if not status then
    reply_type = TMessageType.EXCEPTION
    result = TApplicationException:new{message = res}
  elseif ttype(res) == 'ServiceException' then
...
function WriteHomeTimeline_args:write(oprot)
  ...
  if self.user_mentions_id ~= nil then
    oprot:writeFieldBegin('user_mentions_id', TType.LIST, 8)
...
return HomeTimelineServiceClient, HomeTimelineServiceProcessor