...
class ComposePostHandler : public ComposePostServiceIf {
 public:
  ...
  void ComposePost(
		   ...
		   int64_t req_id, const std::string &username, int64_t user_id,
 ...
 private:
  ...
  std::string compose_post = "/stats/compose-post";
  std::string redis = "/stats/user-timeline-redis";
  std::string mongodb = "/stats/user-timeline-mongodb";
  FILE* ff1,ff2,ff3;
...
Creator ComposePostHandler::_ComposeCreaterHelper(
  ...
  try {
    user_client->ComposeCreatorWithUserId(_return_creator, flow, timestamp2, level, req_id, user_id,
...
TextServiceReturn ComposePostHandler::_ComposeTextHelper(
  ...
  try {
    text_client->ComposeText(_return_text, flow, timestamp2, level, req_id, text, writer_text_map);
  } catch (...) {
...
std::vector<Media> ComposePostHandler::_ComposeMediaHelper(
  ...
  try {
    media_client->ComposeMedia(_return_media, flow, timestamp2, level, req_id, media_types, media_ids,
                               writer_text_map);
  } catch (...) {
...
int64_t ComposePostHandler::_ComposeUniqueIdHelper(
  ...
  try {
    _return_unique_id =
        unique_id_client->ComposeUniqueId(flow, timestamp2, level, req_id, post_type, writer_text_map);
  } catch (...) {
...
void ComposePostHandler::_UploadPostHelper(
  ...
  try {
    post_storage_client->StorePost(flow, timestamp2, level, req_id, post, writer_text_map);
  } catch (...) {
...
void ComposePostHandler::_UploadUserTimelineHelper(
  ...
  try {
    user_timeline_client->WriteUserTimeline(flow, timestamp2, level, req_id, post_id, user_id, timestamp,
                                            writer_text_map);
  } catch (...) {
...
void ComposePostHandler::_UploadHomeTimelineHelper(
  ...
  try {
    home_timeline_client->WriteHomeTimeline(flow, timestamp2, level, req_id, post_id, user_id, timestamp,
...
void ComposePostHandler::ComposePost(
  ...
  auto text_future =
      std::async(std::launch::async, &ComposePostHandler::_ComposeTextHelper,
                 this, flow, timestamp2, level+1, req_id, text, writer_text_map);
  auto creator_future =
      std::async(std::launch::async, &ComposePostHandler::_ComposeCreaterHelper,
                 this, flow, timestamp2, level+2, req_id, user_id, username, writer_text_map);
  auto media_future =
      std::async(std::launch::async, &ComposePostHandler::_ComposeMediaHelper,
                 this, flow, timestamp2, level+3, req_id, media_types, media_ids, writer_text_map);
  auto unique_id_future = std::async(
      std::launch::async, &ComposePostHandler::_ComposeUniqueIdHelper, this,
      flow, timestamp2, level+4, req_id, post_type, writer_text_map);
  ...
  auto post_future =
      std::async(std::launch::async, &ComposePostHandler::_UploadPostHelper,
                 this, flow, timestamp2, level+5, req_id, post, writer_text_map);
  auto user_timeline_future = std::async(
      std::launch::deferred, &ComposePostHandler::_UploadUserTimelineHelper, this,
      flow, timestamp2, level+6, req_id, post.post_id, user_id, timestamp, writer_text_map);
  auto home_timeline_future = std::async(
      std::launch::deferred, &ComposePostHandler::_UploadHomeTimelineHelper, this,
      flow, timestamp2, level+7, req_id, post.post_id, user_id, timestamp, user_mention_ids,
      writer_text_map);
