...
class UniqueIdServiceIf {
 public:
  ...
  virtual int64_t ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier) = 0;
};
...
class UniqueIdServiceNull : virtual public UniqueIdServiceIf {
 public:
  ...
  int64_t ComposeUniqueId(const int8_t /* flow */, const int64_t /* timestamp */, const int16_t /* edge */, const int64_t /* req_id */, const PostType::type /* post_type */, const std::map<std::string, std::string> & /* carrier */) {
    int64_t _return = 0;
    return _return;
  }
};
...
typedef struct _UniqueIdService_ComposeUniqueId_args__isset {
  _UniqueIdService_ComposeUniqueId_args__isset() : flow(false), timestamp(false), edge(false), req_id(false), post_type(false), carrier(false) {}
  bool flow :1;
  bool timestamp :1;
  bool edge :1;
  bool req_id :1;
...
class UniqueIdService_ComposeUniqueId_args {
 public:
  ...
  UniqueIdService_ComposeUniqueId_args() : flow(0), timestamp(0), edge(0), req_id(0), post_type((PostType::type)0) {
  }
...
class UniqueIdServiceClient : virtual public UniqueIdServiceIf {
 ...
 public:
  ...
  int64_t ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier);
  void send_ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier);
...
class UniqueIdServiceMultiface : virtual public UniqueIdServiceIf {
 ...
 public:
  int64_t ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier);
    }
    return ifaces_[i]->ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier);
  }
...
class UniqueIdServiceConcurrentClient : virtual public UniqueIdServiceIf {
 ...
 public:
  ...
  int64_t ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier);
  int32_t send_ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier);
