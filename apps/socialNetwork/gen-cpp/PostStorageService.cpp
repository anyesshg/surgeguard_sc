...
uint32_t PostStorageService_StorePost_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("post", ::apache::thrift::protocol::T_STRUCT, 5);
...
uint32_t PostStorageService_ReadPosts_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("post_ids", ::apache::thrift::protocol::T_LIST, 5);
  {
...
void PostStorageServiceClient::StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier)
{
  send_StorePost(flow, timestamp2, edge, req_id, post, carrier);
  recv_StorePost();
}

void PostStorageServiceClient::send_StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void PostStorageServiceClient::ReadPost(Post& _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier)
{
  send_ReadPost(flow, timestamp2, edge, req_id, post_id, carrier);
  recv_ReadPost(_return);
}

void PostStorageServiceClient::send_ReadPost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void PostStorageServiceClient::ReadPosts(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier)
{
  send_ReadPosts(flow, timestamp2, edge, req_id, post_ids, carrier);
  recv_ReadPosts(_return);
}

void PostStorageServiceClient::send_ReadPosts(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void PostStorageServiceProcessor::process_StorePost(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->StorePost(args.flow, args.timestamp2, args.edge, args.req_id, args.post, args.carrier);
...
void PostStorageServiceProcessor::process_ReadPost(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ReadPost(result.success, args.flow, args.timestamp2, args.edge, args.req_id, args.post_id, args.carrier);
...
void PostStorageServiceProcessor::process_ReadPosts(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ReadPosts(result.success, args.flow, args.timestamp2, args.edge, args.req_id, args.post_ids, args.carrier);
    result.__isset.success = true;
  } catch (ServiceException &se) {
    result.se = se;
    result.__isset.se = true;
...
void PostStorageServiceConcurrentClient::StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_StorePost(flow, timestamp2, edge, req_id, post, carrier);
  recv_StorePost(seqid);
}

int32_t PostStorageServiceConcurrentClient::send_StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier)
{
...
void PostStorageServiceConcurrentClient::ReadPost(Post& _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ReadPost(flow, timestamp2, edge, req_id, post_id, carrier);
  recv_ReadPost(_return, seqid);
}

int32_t PostStorageServiceConcurrentClient::send_ReadPost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("ReadPost", ::apache::thrift::protocol::T_CALL, cseqid);
...
void PostStorageServiceConcurrentClient::ReadPosts(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ReadPosts(flow, timestamp2, edge, req_id, post_ids, carrier);
  recv_ReadPosts(_return, seqid);
}

int32_t PostStorageServiceConcurrentClient::send_ReadPosts(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("ReadPosts", ::apache::thrift::protocol::T_CALL, cseqid);
