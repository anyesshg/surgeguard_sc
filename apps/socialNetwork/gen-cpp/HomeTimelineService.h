...
class HomeTimelineServiceIf {
 public:
  ...
  virtual void ReadHomeTimeline(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier) = 0;
  virtual void WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier) = 0;
};
...
class HomeTimelineServiceNull : virtual public HomeTimelineServiceIf {
 public:
  ...
  void ReadHomeTimeline(std::vector<Post> & /* _return */, const int8_t /* flow */, const int64_t /* timestamp2 */, const int16_t /* edge */, const int64_t /* req_id */, const int64_t /* user_id */, const int32_t /* start */, const int32_t /* stop */, const std::map<std::string, std::string> & /* carrier */) {
    return;
  }
  void WriteHomeTimeline(const int8_t /* flow */, const int64_t /* timestamp2 */, const int16_t /* edge */, const int64_t /* req_id */, const int64_t /* post_id */, const int64_t /* user_id */, const int64_t /* timestamp */, const std::vector<int64_t> & /* user_mentions_id */, const std::map<std::string, std::string> & /* carrier */) {
    return;
  }
};

typedef struct _HomeTimelineService_ReadHomeTimeline_args__isset {
  _HomeTimelineService_ReadHomeTimeline_args__isset() : flow(false), timestamp2(false), edge(false), req_id(false), user_id(false), start(false), stop(false), carrier(false) {}
  bool flow :1;
  bool timestamp2 :1;
  bool edge :1;
  bool req_id :1;
...
class HomeTimelineService_ReadHomeTimeline_args {
 public:
  ...
  HomeTimelineService_ReadHomeTimeline_args() : flow(0), timestamp2(0), edge(0), req_id(0), user_id(0), start(0), stop(0) {
  }
...
typedef struct _HomeTimelineService_WriteHomeTimeline_args__isset {
  _HomeTimelineService_WriteHomeTimeline_args__isset() : flow(false), timestamp2(false), edge(false), req_id(false), post_id(false), user_id(false), timestamp(false), user_mentions_id(false), carrier(false) {}
  bool flow :1;
  bool timestamp2 :1;
  bool edge :1;
  bool req_id :1;
...
class HomeTimelineService_WriteHomeTimeline_args {
 public:
  ...
  HomeTimelineService_WriteHomeTimeline_args() : flow(0), timestamp2(0), edge(0), req_id(0), post_id(0), user_id(0), timestamp(0) {
  }
...
class HomeTimelineServiceClient : virtual public HomeTimelineServiceIf {
 ...
 public:
  ...
  void ReadHomeTimeline(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier);
  void send_ReadHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier);
  void recv_ReadHomeTimeline(std::vector<Post> & _return);
  void WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier);
  void send_WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier);
...
class HomeTimelineServiceMultiface : virtual public HomeTimelineServiceIf {
 ...
 public:
  void ReadHomeTimeline(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ReadHomeTimeline(_return, flow, timestamp2, edge, req_id, user_id, start, stop, carrier);
    }
    ifaces_[i]->ReadHomeTimeline(_return, flow, timestamp2, edge, req_id, user_id, start, stop, carrier);
    return;
  }
  ...
  void WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier);
    }
    ifaces_[i]->WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier);
  }
...
class HomeTimelineServiceConcurrentClient : virtual public HomeTimelineServiceIf {
 ...
 public:
  ...
  void ReadHomeTimeline(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier);
  int32_t send_ReadHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier);
  void recv_ReadHomeTimeline(std::vector<Post> & _return, const int32_t seqid);
  void WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier);
  int32_t send_WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier);
