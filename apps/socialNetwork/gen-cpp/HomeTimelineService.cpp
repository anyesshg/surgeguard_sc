...
uint32_t HomeTimelineService_WriteHomeTimeline_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("user_mentions_id", ::apache::thrift::protocol::T_LIST, 8);
  {
  ...
  xfer += oprot->writeFieldBegin("carrier", ::apache::thrift::protocol::T_MAP, 9);
  {
    xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_STRING, ::apache::thrift::protocol::T_STRING, static_cast<uint32_t>(this->carrier.size()));
...
void HomeTimelineServiceClient::ReadHomeTimeline(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier)
{
  send_ReadHomeTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier);
  recv_ReadHomeTimeline(_return);
}

void HomeTimelineServiceClient::send_ReadHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void HomeTimelineServiceClient::WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier)
{
  send_WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier);
  recv_WriteHomeTimeline();
}

void HomeTimelineServiceClient::send_WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void HomeTimelineServiceProcessor::process_ReadHomeTimeline(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ReadHomeTimeline(result.success, args.flow, args.timestamp2, args.edge, args.req_id, args.user_id, args.start, args.stop, args.carrier);
...
void HomeTimelineServiceProcessor::process_WriteHomeTimeline(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->WriteHomeTimeline(args.flow, args.timestamp2, args.edge, args.req_id, args.post_id, args.user_id, args.timestamp, args.user_mentions_id, args.carrier);
  } catch (ServiceException &se) {
    result.se = se;
    result.__isset.se = true;
  } catch (const std::exception& e) {
...
void HomeTimelineServiceConcurrentClient::ReadHomeTimeline(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ReadHomeTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier);
  recv_ReadHomeTimeline(_return, seqid);
}

int32_t HomeTimelineServiceConcurrentClient::send_ReadHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier)
{
...
void HomeTimelineServiceConcurrentClient::WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_WriteHomeTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier);
  recv_WriteHomeTimeline(seqid);
}

int32_t HomeTimelineServiceConcurrentClient::send_WriteHomeTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::vector<int64_t> & user_mentions_id, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("WriteHomeTimeline", ::apache::thrift::protocol::T_CALL, cseqid);
