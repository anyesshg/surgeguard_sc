...
void TextServiceClient::ComposeText(TextServiceReturn& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier)
{
  send_ComposeText(flow, timestamp, edge, req_id, text, carrier);
  recv_ComposeText(_return);
}

void TextServiceClient::send_ComposeText(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void TextServiceProcessor::process_ComposeText(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ComposeText(result.success, args.flow, args.timestamp, args.edge, args.req_id, args.text, args.carrier);
...
void TextServiceConcurrentClient::ComposeText(TextServiceReturn& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ComposeText(flow, timestamp, edge, req_id, text, carrier);
  recv_ComposeText(_return, seqid);
}

int32_t TextServiceConcurrentClient::send_ComposeText(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier)
{
