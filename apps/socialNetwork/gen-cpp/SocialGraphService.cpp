...
void SocialGraphServiceClient::GetFollowers(std::vector<int64_t> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier)
{
  send_GetFollowers(flow, timestamp, edge, req_id, user_id, carrier);
  recv_GetFollowers(_return);
}

void SocialGraphServiceClient::send_GetFollowers(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void SocialGraphServiceProcessor::process_GetFollowers(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->GetFollowers(result.success, args.flow, args.timestamp, args.edge, args.req_id, args.user_id, args.carrier);
...
void SocialGraphServiceConcurrentClient::GetFollowers(std::vector<int64_t> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_GetFollowers(flow, timestamp, edge, req_id, user_id, carrier);
  recv_GetFollowers(_return, seqid);
}

int32_t SocialGraphServiceConcurrentClient::send_GetFollowers(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier)
{
