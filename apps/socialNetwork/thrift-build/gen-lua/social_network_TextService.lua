...
function TextServiceClient:ComposeText(flow, timestamp, edge, req_id, text, carrier)
  self:send_ComposeText(flow, timestamp, edge, req_id, text, carrier)
  return self:recv_ComposeText(flow, timestamp, edge, req_id, text, carrier)
end

function TextServiceClient:send_ComposeText(flow, timestamp, edge, req_id, text, carrier)
...
function TextServiceClient:recv_ComposeText(flow, timestamp, edge, req_id, text, carrier)
...
function TextServiceProcessor:process_ComposeText(seqid, iprot, oprot, server_ctx)
  ...
  iprot:readMessageEnd()
  local result = ComposeText_result:new{}
  local status, res = pcall(self.handler.ComposeText, self.handler, args.flow, args.timestamp, args.edge, args.req_id, args.text, args.carrier)
  if not status then
