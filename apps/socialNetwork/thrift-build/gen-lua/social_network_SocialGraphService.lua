...
function SocialGraphServiceClient:GetFollowers(flow, timestamp, edge, req_id, user_id, carrier)
  self:send_GetFollowers(flow, timestamp, edge, req_id, user_id, carrier)
  return self:recv_GetFollowers(flow, timestamp, edge, req_id, user_id, carrier)
end

function SocialGraphServiceClient:send_GetFollowers(flow, timestamp, edge, req_id, user_id, carrier)
...
function SocialGraphServiceClient:recv_GetFollowers(flow, timestamp, edge, req_id, user_id, carrier)
...
function SocialGraphServiceProcessor:process_GetFollowers(seqid, iprot, oprot, server_ctx)
  ...
  iprot:readMessageEnd()
  local result = GetFollowers_result:new{}
  local status, res = pcall(self.handler.GetFollowers, self.handler, args.flow, args.timestamp, args.edge, args.req_id, args.user_id, args.carrier)
  if not status then
...
return SocialGraphServiceClient, SocialGraphServiceProcessor