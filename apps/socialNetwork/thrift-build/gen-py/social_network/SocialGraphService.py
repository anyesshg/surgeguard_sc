...
class Iface(object):
    def GetFollowers(self, flow, timestamp, edge, req_id, user_id, carrier):
        """
        Parameters:
         - flow
         - timestamp
...
class Client(Iface):
    ...
    def send_GetFollowers(self, flow, timestamp, edge, req_id, user_id, carrier):
...
class Processor(Iface, TProcessor):
    ...
    def process_GetFollowers(self, seqid, iprot, oprot):
        ...
        result = GetFollowers_result()
        try:
            result.success = self._handler.GetFollowers(args.flow, args.timestamp, args.edge, args.req_id, args.user_id, args.carrier)
...
class GetFollowers_args(object):
    ...
    def __init__(self, flow=None, timestamp=None, edge=None, req_id=None, user_id=None, carrier=None,):
        self.flow = flow
