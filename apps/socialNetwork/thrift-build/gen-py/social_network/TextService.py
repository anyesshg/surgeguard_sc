...
class Iface(object):
    def ComposeText(self, flow, timestamp, edge, req_id, text, carrier):
        """
        Parameters:
         - flow
         - timestamp
...
class Client(Iface):
    ...
    def send_ComposeText(self, flow, timestamp, edge, req_id, text, carrier):
...
class Processor(Iface, TProcessor):
    ...
    def process_ComposeText(self, seqid, iprot, oprot):
        ...
        result = ComposeText_result()
        try:
            result.success = self._handler.ComposeText(args.flow, args.timestamp, args.edge, args.req_id, args.text, args.carrier)
...
class ComposeText_args(object):
    ...
    def __init__(self, flow=None, timestamp=None, edge=None, req_id=None, text=None, carrier=None,):
        self.flow = flow
