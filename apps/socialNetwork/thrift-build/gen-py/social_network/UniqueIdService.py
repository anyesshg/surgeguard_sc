...
class Iface(object):
    def ComposeUniqueId(self, flow, timestamp, edge, req_id, post_type, carrier):
        """
        Parameters:
         - flow
         - timestamp
...
class Client(Iface):
    ...
    def send_ComposeUniqueId(self, flow, timestamp, edge, req_id, post_type, carrier):
...
class Processor(Iface, TProcessor):
    ...
    def process_ComposeUniqueId(self, seqid, iprot, oprot):
        ...
        result = ComposeUniqueId_result()
        try:
            result.success = self._handler.ComposeUniqueId(args.flow, args.timestamp, args.edge, args.req_id, args.post_type, args.carrier)
...
class ComposeUniqueId_args(object):
    ...
    def __init__(self, flow=None, timestamp=None, edge=None, req_id=None, post_type=None, carrier=None,):
        self.flow = flow
...
ComposeUniqueId_args.thrift_spec = (
    ...
    (5, TType.I32, 'post_type', None, None, ),  # 5
