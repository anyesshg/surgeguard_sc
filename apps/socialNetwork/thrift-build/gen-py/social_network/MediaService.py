...
class Iface(object):
    def ComposeMedia(self, flow, timestamp, edge, req_id, media_types, media_ids, carrier):
        """
        Parameters:
         - flow
         - timestamp
...
class Client(Iface):
    ...
    def send_ComposeMedia(self, flow, timestamp, edge, req_id, media_types, media_ids, carrier):
...
class Processor(Iface, TProcessor):
    ...
    def process_ComposeMedia(self, seqid, iprot, oprot):
        ...
        result = ComposeMedia_result()
        try:
            result.success = self._handler.ComposeMedia(args.flow, args.timestamp, args.edge, args.req_id, args.media_types, args.media_ids, args.carrier)
...
class ComposeMedia_args(object):
    ...
    def __init__(self, flow=None, timestamp=None, edge=None, req_id=None, media_types=None, media_ids=None, carrier=None,):
        self.flow = flow
...
ComposeMedia_args.thrift_spec = (
    ...
    (6, TType.LIST, 'media_ids', (TType.I64, None, False), None, ),  # 6
