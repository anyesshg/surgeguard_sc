...
uint32_t MediaService_ComposeMedia_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("media_ids", ::apache::thrift::protocol::T_LIST, 6);
  {
...
void MediaServiceClient::ComposeMedia(std::vector<Media> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier)
{
  send_ComposeMedia(flow, timestamp, edge, req_id, media_types, media_ids, carrier);
  recv_ComposeMedia(_return);
}

void MediaServiceClient::send_ComposeMedia(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void MediaServiceProcessor::process_ComposeMedia(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ComposeMedia(result.success, args.flow, args.timestamp, args.edge, args.req_id, args.media_types, args.media_ids, args.carrier);
...
void MediaServiceConcurrentClient::ComposeMedia(std::vector<Media> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ComposeMedia(flow, timestamp, edge, req_id, media_types, media_ids, carrier);
  recv_ComposeMedia(_return, seqid);
}

int32_t MediaServiceConcurrentClient::send_ComposeMedia(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier)
{
