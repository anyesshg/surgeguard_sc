...
class MediaServiceIf {
 public:
  ...
  virtual void ComposeMedia(std::vector<Media> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier) = 0;
};
...
class MediaServiceNull : virtual public MediaServiceIf {
 public:
  ...
  void ComposeMedia(std::vector<Media> & /* _return */, const int8_t /* flow */, const int64_t /* timestamp */, const int16_t /* edge */, const int64_t /* req_id */, const std::vector<std::string> & /* media_types */, const std::vector<int64_t> & /* media_ids */, const std::map<std::string, std::string> & /* carrier */) {
    return;
  }
};

typedef struct _MediaService_ComposeMedia_args__isset {
  _MediaService_ComposeMedia_args__isset() : flow(false), timestamp(false), edge(false), req_id(false), media_types(false), media_ids(false), carrier(false) {}
  bool flow :1;
  bool timestamp :1;
  bool edge :1;
  bool req_id :1;
...
class MediaService_ComposeMedia_args {
 public:
  ...
  MediaService_ComposeMedia_args() : flow(0), timestamp(0), edge(0), req_id(0) {
  }
...
class MediaServiceClient : virtual public MediaServiceIf {
 ...
 public:
  ...
  void ComposeMedia(std::vector<Media> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier);
  void send_ComposeMedia(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier);
...
class MediaServiceMultiface : virtual public MediaServiceIf {
 ...
 public:
  void ComposeMedia(std::vector<Media> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ComposeMedia(_return, flow, timestamp, edge, req_id, media_types, media_ids, carrier);
    }
    ifaces_[i]->ComposeMedia(_return, flow, timestamp, edge, req_id, media_types, media_ids, carrier);
    return;
  }
...
class MediaServiceConcurrentClient : virtual public MediaServiceIf {
 ...
 public:
  ...
  void ComposeMedia(std::vector<Media> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier);
  int32_t send_ComposeMedia(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::vector<std::string> & media_types, const std::vector<int64_t> & media_ids, const std::map<std::string, std::string> & carrier);
