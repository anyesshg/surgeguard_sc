...
uint32_t ComposePostService_ComposePost_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("text", ::apache::thrift::protocol::T_STRING, 7);
  xfer += oprot->writeString(this->text);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("media_ids", ::apache::thrift::protocol::T_LIST, 8);
  {
  ...
  xfer += oprot->writeFieldBegin("media_types", ::apache::thrift::protocol::T_LIST, 9);
  {
  ...
  xfer += oprot->writeFieldBegin("post_type", ::apache::thrift::protocol::T_I32, 10);
...
void ComposePostServiceClient::ComposePost(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& username, const int64_t user_id, const std::string& text, const std::vector<int64_t> & media_ids, const std::vector<std::string> & media_types, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
  send_ComposePost(flow, timestamp, edge, req_id, username, user_id, text, media_ids, media_types, post_type, carrier);
  recv_ComposePost();
}

void ComposePostServiceClient::send_ComposePost(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& username, const int64_t user_id, const std::string& text, const std::vector<int64_t> & media_ids, const std::vector<std::string> & media_types, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void ComposePostServiceProcessor::process_ComposePost(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ComposePost(args.flow, args.timestamp, args.edge, args.req_id, args.username, args.user_id, args.text, args.media_ids, args.media_types, args.post_type, args.carrier);
...
void ComposePostServiceConcurrentClient::ComposePost(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& username, const int64_t user_id, const std::string& text, const std::vector<int64_t> & media_ids, const std::vector<std::string> & media_types, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ComposePost(flow, timestamp, edge, req_id, username, user_id, text, media_ids, media_types, post_type, carrier);
  recv_ComposePost(seqid);
}

int32_t ComposePostServiceConcurrentClient::send_ComposePost(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& username, const int64_t user_id, const std::string& text, const std::vector<int64_t> & media_ids, const std::vector<std::string> & media_types, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
