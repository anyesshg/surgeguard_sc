...
class TextServiceIf {
 public:
  ...
  virtual void ComposeText(TextServiceReturn& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier) = 0;
};
...
typedef struct _TextService_ComposeText_args__isset {
  _TextService_ComposeText_args__isset() : flow(false), timestamp(false), edge(false), req_id(false), text(false), carrier(false) {}
  bool flow :1;
  bool timestamp :1;
  bool edge :1;
  bool req_id :1;
...
class TextService_ComposeText_args {
 public:
  ...
  TextService_ComposeText_args() : flow(0), timestamp(0), edge(0), req_id(0), text() {
  }
...
class TextServiceClient : virtual public TextServiceIf {
 ...
 public:
  ...
  void ComposeText(TextServiceReturn& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier);
  void send_ComposeText(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier);
...
class TextServiceMultiface : virtual public TextServiceIf {
 ...
 public:
  void ComposeText(TextServiceReturn& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ComposeText(_return, flow, timestamp, edge, req_id, text, carrier);
    }
    ifaces_[i]->ComposeText(_return, flow, timestamp, edge, req_id, text, carrier);
    return;
  }
...
class TextServiceConcurrentClient : virtual public TextServiceIf {
 ...
 public:
  ...
  void ComposeText(TextServiceReturn& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier);
  int32_t send_ComposeText(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const std::string& text, const std::map<std::string, std::string> & carrier);
