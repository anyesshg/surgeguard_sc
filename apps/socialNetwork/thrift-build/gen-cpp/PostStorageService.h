...
class PostStorageServiceIf {
 public:
  ...
  virtual void StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier) = 0;
  virtual void ReadPost(Post& _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier) = 0;
  virtual void ReadPosts(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier) = 0;
};
...
typedef struct _PostStorageService_StorePost_args__isset {
  _PostStorageService_StorePost_args__isset() : flow(false), timestamp2(false), edge(false), req_id(false), post(false), carrier(false) {}
  bool flow :1;
  bool timestamp2 :1;
  bool edge :1;
  bool req_id :1;
...
class PostStorageService_StorePost_args {
 public:
  ...
  PostStorageService_StorePost_args() : flow(0), timestamp2(0), edge(0), req_id(0) {
  }
...
typedef struct _PostStorageService_ReadPost_args__isset {
  _PostStorageService_ReadPost_args__isset() : flow(false), timestamp2(false), edge(false), req_id(false), post_id(false), carrier(false) {}
  bool flow :1;
  bool timestamp2 :1;
  bool edge :1;
  bool req_id :1;
...
class PostStorageService_ReadPost_args {
 public:
  ...
  PostStorageService_ReadPost_args() : flow(0), timestamp2(0), edge(0), req_id(0), post_id(0) {
  }
...
typedef struct _PostStorageService_ReadPosts_args__isset {
  _PostStorageService_ReadPosts_args__isset() : flow(false), timestamp2(false), edge(false), req_id(false), post_ids(false), carrier(false) {}
  bool flow :1;
  bool timestamp2 :1;
  bool edge :1;
  bool req_id :1;
...
class PostStorageService_ReadPosts_args {
 public:
  ...
  PostStorageService_ReadPosts_args() : flow(0), timestamp2(0), edge(0), req_id(0) {
  }
...
class PostStorageServiceClient : virtual public PostStorageServiceIf {
 ...
 public:
  ...
  void StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier);
  void send_StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier);
  void recv_StorePost();
  void ReadPost(Post& _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier);
  void send_ReadPost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier);
  void recv_ReadPost(Post& _return);
  void ReadPosts(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier);
  void send_ReadPosts(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier);
...
class PostStorageServiceMultiface : virtual public PostStorageServiceIf {
 ...
 public:
  void StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->StorePost(flow, timestamp2, edge, req_id, post, carrier);
    }
    ifaces_[i]->StorePost(flow, timestamp2, edge, req_id, post, carrier);
  }
  ...
  void ReadPost(Post& _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ReadPost(_return, flow, timestamp2, edge, req_id, post_id, carrier);
    }
    ifaces_[i]->ReadPost(_return, flow, timestamp2, edge, req_id, post_id, carrier);
    return;
  }
  ...
  void ReadPosts(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ReadPosts(_return, flow, timestamp2, edge, req_id, post_ids, carrier);
    }
    ifaces_[i]->ReadPosts(_return, flow, timestamp2, edge, req_id, post_ids, carrier);
    return;
  }
...
class PostStorageServiceConcurrentClient : virtual public PostStorageServiceIf {
 ...
 public:
  ...
  void StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier);
  int32_t send_StorePost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const Post& post, const std::map<std::string, std::string> & carrier);
  void recv_StorePost(const int32_t seqid);
  void ReadPost(Post& _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier);
  int32_t send_ReadPost(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const std::map<std::string, std::string> & carrier);
  void recv_ReadPost(Post& _return, const int32_t seqid);
  void ReadPosts(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier);
  int32_t send_ReadPosts(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const std::vector<int64_t> & post_ids, const std::map<std::string, std::string> & carrier);
