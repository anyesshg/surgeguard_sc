...
void UserServiceClient::ComposeCreatorWithUserId(Creator& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier)
{
  send_ComposeCreatorWithUserId(flow, timestamp, edge, req_id, user_id, username, carrier);
  recv_ComposeCreatorWithUserId(_return);
}

void UserServiceClient::send_ComposeCreatorWithUserId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void UserServiceProcessor::process_ComposeCreatorWithUserId(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ComposeCreatorWithUserId(result.success, args.flow, args.timestamp, args.edge, args.req_id, args.user_id, args.username, args.carrier);
    result.__isset.success = true;
  } catch (ServiceException &se) {
    result.se = se;
    result.__isset.se = true;
...
void UserServiceConcurrentClient::ComposeCreatorWithUserId(Creator& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ComposeCreatorWithUserId(flow, timestamp, edge, req_id, user_id, username, carrier);
  recv_ComposeCreatorWithUserId(_return, seqid);
}

int32_t UserServiceConcurrentClient::send_ComposeCreatorWithUserId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("ComposeCreatorWithUserId", ::apache::thrift::protocol::T_CALL, cseqid);
