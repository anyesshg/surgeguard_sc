...
class UserServiceIf {
 public:
  ...
  virtual void ComposeCreatorWithUserId(Creator& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier) = 0;
...
class UserServiceNull : virtual public UserServiceIf {
 public:
  ...
  void ComposeCreatorWithUserId(Creator& /* _return */, const int8_t /* flow */, const int64_t /* timestamp */, const int16_t /* edge */, const int64_t /* req_id */, const int64_t /* user_id */, const std::string& /* username */, const std::map<std::string, std::string> & /* carrier */) {
    return;
  }
...
typedef struct _UserService_ComposeCreatorWithUserId_args__isset {
  _UserService_ComposeCreatorWithUserId_args__isset() : flow(false), timestamp(false), edge(false), req_id(false), user_id(false), username(false), carrier(false) {}
  bool flow :1;
  bool timestamp :1;
  bool edge :1;
  bool req_id :1;
...
class UserService_ComposeCreatorWithUserId_args {
 public:
  ...
  UserService_ComposeCreatorWithUserId_args() : flow(0), timestamp(0), edge(0), req_id(0), user_id(0), username() {
  }
...
class UserServiceClient : virtual public UserServiceIf {
 ...
 public:
  ...
  void ComposeCreatorWithUserId(Creator& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier);
  void send_ComposeCreatorWithUserId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier);
...
class UserServiceMultiface : virtual public UserServiceIf {
 ...
 public:
  ...
  void ComposeCreatorWithUserId(Creator& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ComposeCreatorWithUserId(_return, flow, timestamp, edge, req_id, user_id, username, carrier);
    }
    ifaces_[i]->ComposeCreatorWithUserId(_return, flow, timestamp, edge, req_id, user_id, username, carrier);
    return;
  }
...
class UserServiceConcurrentClient : virtual public UserServiceIf {
 ...
 public:
  ...
  void ComposeCreatorWithUserId(Creator& _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier);
  int32_t send_ComposeCreatorWithUserId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::string& username, const std::map<std::string, std::string> & carrier);
