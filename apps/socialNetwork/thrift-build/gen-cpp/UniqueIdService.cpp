...
uint32_t UniqueIdService_ComposeUniqueId_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("post_type", ::apache::thrift::protocol::T_I32, 5);
...
int64_t UniqueIdServiceClient::ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
  send_ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier);
  return recv_ComposeUniqueId();
}

void UniqueIdServiceClient::send_ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void UniqueIdServiceProcessor::process_ComposeUniqueId(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->ComposeUniqueId(args.flow, args.timestamp, args.edge, args.req_id, args.post_type, args.carrier);
...
int64_t UniqueIdServiceConcurrentClient::ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ComposeUniqueId(flow, timestamp, edge, req_id, post_type, carrier);
  return recv_ComposeUniqueId(seqid);
}

int32_t UniqueIdServiceConcurrentClient::send_ComposeUniqueId(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const PostType::type post_type, const std::map<std::string, std::string> & carrier)
{
