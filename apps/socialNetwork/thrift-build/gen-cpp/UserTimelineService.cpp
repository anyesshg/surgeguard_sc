    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I64) {
          xfer += iprot->readI64(this->timestamp2);
          this->__isset.timestamp2 = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t UserTimelineService_WriteUserTimeline_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("timestamp2", ::apache::thrift::protocol::T_I64, 2);
  xfer += oprot->writeI64(this->timestamp2);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("edge", ::apache::thrift::protocol::T_I16, 3);
  xfer += oprot->writeI16(this->edge);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("post_id", ::apache::thrift::protocol::T_I64, 5);
...
uint32_t UserTimelineService_ReadUserTimeline_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("start", ::apache::thrift::protocol::T_I32, 6);
  xfer += oprot->writeI32(this->start);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("stop", ::apache::thrift::protocol::T_I32, 7);
...
UserTimelineService_Print_args::~UserTimelineService_Print_args() throw() {
}


uint32_t UserTimelineService_Print_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t UserTimelineService_Print_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("UserTimelineService_Print_args");
...
UserTimelineService_Print_pargs::~UserTimelineService_Print_pargs() throw() {
}


uint32_t UserTimelineService_Print_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("UserTimelineService_Print_pargs");
...
UserTimelineService_Print_result::~UserTimelineService_Print_result() throw() {
}


uint32_t UserTimelineService_Print_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t UserTimelineService_Print_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("UserTimelineService_Print_result");
...
UserTimelineService_Print_presult::~UserTimelineService_Print_presult() throw() {
}


uint32_t UserTimelineService_Print_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
UserTimelineService_Reset_args::~UserTimelineService_Reset_args() throw() {
}


uint32_t UserTimelineService_Reset_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t UserTimelineService_Reset_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("UserTimelineService_Reset_args");
...
UserTimelineService_Reset_pargs::~UserTimelineService_Reset_pargs() throw() {
}


uint32_t UserTimelineService_Reset_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("UserTimelineService_Reset_pargs");
...
UserTimelineService_Reset_result::~UserTimelineService_Reset_result() throw() {
}


uint32_t UserTimelineService_Reset_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t UserTimelineService_Reset_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("UserTimelineService_Reset_result");
...
UserTimelineService_Reset_presult::~UserTimelineService_Reset_presult() throw() {
}


uint32_t UserTimelineService_Reset_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void UserTimelineServiceClient::WriteUserTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::map<std::string, std::string> & carrier)
{
  send_WriteUserTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, carrier);
  recv_WriteUserTimeline();
}

void UserTimelineServiceClient::send_WriteUserTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void UserTimelineServiceClient::ReadUserTimeline(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier)
{
  send_ReadUserTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier);
  recv_ReadUserTimeline(_return);
}

void UserTimelineServiceClient::send_ReadUserTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = 0;
...
void UserTimelineServiceClient::Print()
{
  send_Print();
  recv_Print();
}

void UserTimelineServiceClient::send_Print()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("Print", ::apache::thrift::protocol::T_CALL, cseqid);

  UserTimelineService_Print_pargs args;
  args.write(oprot_);
...
void UserTimelineServiceClient::recv_Print()
{
  ...
  if (fname.compare("Print") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  UserTimelineService_Print_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void UserTimelineServiceClient::Reset()
{
  send_Reset();
  recv_Reset();
}

void UserTimelineServiceClient::send_Reset()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("Reset", ::apache::thrift::protocol::T_CALL, cseqid);

  UserTimelineService_Reset_pargs args;
  args.write(oprot_);
...
void UserTimelineServiceClient::recv_Reset()
{
  ...
  UserTimelineService_Reset_presult result;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void UserTimelineServiceProcessor::process_WriteUserTimeline(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->WriteUserTimeline(args.flow, args.timestamp2, args.edge, args.req_id, args.post_id, args.user_id, args.timestamp, args.carrier);
...
void UserTimelineServiceProcessor::process_ReadUserTimeline(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->ReadUserTimeline(result.success, args.flow, args.timestamp2, args.edge, args.req_id, args.user_id, args.start, args.stop, args.carrier);
...
void UserTimelineServiceProcessor::process_Print(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("UserTimelineService.Print", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "UserTimelineService.Print");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "UserTimelineService.Print");
  }

  UserTimelineService_Print_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "UserTimelineService.Print", bytes);
  }

  UserTimelineService_Print_result result;
  try {
    iface_->Print();
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "UserTimelineService.Print");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("Print", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "UserTimelineService.Print");
  }

  oprot->writeMessageBegin("Print", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "UserTimelineService.Print", bytes);
  }
}

void UserTimelineServiceProcessor::process_Reset(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("UserTimelineService.Reset", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "UserTimelineService.Reset");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "UserTimelineService.Reset");
  }

  UserTimelineService_Reset_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "UserTimelineService.Reset", bytes);
  }

  UserTimelineService_Reset_result result;
  try {
    iface_->Reset();
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "UserTimelineService.Reset");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "UserTimelineService.Reset");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "UserTimelineService.Reset", bytes);
  }
}
...
void UserTimelineServiceConcurrentClient::WriteUserTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_WriteUserTimeline(flow, timestamp2, edge, req_id, post_id, user_id, timestamp, carrier);
  recv_WriteUserTimeline(seqid);
}

int32_t UserTimelineServiceConcurrentClient::send_WriteUserTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t post_id, const int64_t user_id, const int64_t timestamp, const std::map<std::string, std::string> & carrier)
{
...
void UserTimelineServiceConcurrentClient::ReadUserTimeline(std::vector<Post> & _return, const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier)
{
  int32_t seqid = send_ReadUserTimeline(flow, timestamp2, edge, req_id, user_id, start, stop, carrier);
  recv_ReadUserTimeline(_return, seqid);
}

int32_t UserTimelineServiceConcurrentClient::send_ReadUserTimeline(const int8_t flow, const int64_t timestamp2, const int16_t edge, const int64_t req_id, const int64_t user_id, const int32_t start, const int32_t stop, const std::map<std::string, std::string> & carrier)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("ReadUserTimeline", ::apache::thrift::protocol::T_CALL, cseqid);
...
void UserTimelineServiceConcurrentClient::Print()
{
  int32_t seqid = send_Print();
  recv_Print(seqid);
}

int32_t UserTimelineServiceConcurrentClient::send_Print()
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("Print", ::apache::thrift::protocol::T_CALL, cseqid);
...
void UserTimelineServiceConcurrentClient::recv_Print(const int32_t seqid)
{
...
void UserTimelineServiceConcurrentClient::Reset()
{
  int32_t seqid = send_Reset();
  recv_Reset(seqid);
}

int32_t UserTimelineServiceConcurrentClient::send_Reset()
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("Reset", ::apache::thrift::protocol::T_CALL, cseqid);
...
void UserTimelineServiceConcurrentClient::recv_Reset(const int32_t seqid)
{
