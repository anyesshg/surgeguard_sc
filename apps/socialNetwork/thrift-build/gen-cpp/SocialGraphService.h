...
class SocialGraphServiceIf {
 public:
  ...
  virtual void GetFollowers(std::vector<int64_t> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier) = 0;
...
class SocialGraphServiceNull : virtual public SocialGraphServiceIf {
 public:
  ...
  void GetFollowers(std::vector<int64_t> & /* _return */, const int8_t /* flow */, const int64_t /* timestamp */, const int16_t /* edge */, const int64_t /* req_id */, const int64_t /* user_id */, const std::map<std::string, std::string> & /* carrier */) {
    return;
  }
...
typedef struct _SocialGraphService_GetFollowers_args__isset {
  _SocialGraphService_GetFollowers_args__isset() : flow(false), timestamp(false), edge(false), req_id(false), user_id(false), carrier(false) {}
  bool flow :1;
  bool timestamp :1;
  bool edge :1;
  bool req_id :1;
...
class SocialGraphService_GetFollowers_args {
 public:
  ...
  SocialGraphService_GetFollowers_args() : flow(0), timestamp(0), edge(0), req_id(0), user_id(0) {
  }
...
class SocialGraphServiceClient : virtual public SocialGraphServiceIf {
 ...
 public:
  ...
  void GetFollowers(std::vector<int64_t> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier);
  void send_GetFollowers(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier);
...
class SocialGraphServiceMultiface : virtual public SocialGraphServiceIf {
 ...
 public:
  void GetFollowers(std::vector<int64_t> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->GetFollowers(_return, flow, timestamp, edge, req_id, user_id, carrier);
    }
    ifaces_[i]->GetFollowers(_return, flow, timestamp, edge, req_id, user_id, carrier);
    return;
  }
...
class SocialGraphServiceConcurrentClient : virtual public SocialGraphServiceIf {
 ...
 public:
  ...
  void GetFollowers(std::vector<int64_t> & _return, const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier);
  int32_t send_GetFollowers(const int8_t flow, const int64_t timestamp, const int16_t edge, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> & carrier);
