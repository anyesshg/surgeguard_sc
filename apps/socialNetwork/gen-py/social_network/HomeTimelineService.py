...
class Iface(object):
    def ReadHomeTimeline(self, flow, timestamp2, edge, req_id, user_id, start, stop, carrier):
        """
        Parameters:
         - flow
         - timestamp2
    ...
    def WriteHomeTimeline(self, flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier):
        """
        Parameters:
         - flow
         - timestamp2
...
class Client(Iface):
    ...
    def send_ReadHomeTimeline(self, flow, timestamp2, edge, req_id, user_id, start, stop, carrier):
    ...
    def send_WriteHomeTimeline(self, flow, timestamp2, edge, req_id, post_id, user_id, timestamp, user_mentions_id, carrier):
...
class Processor(Iface, TProcessor):
    ...
    def process_ReadHomeTimeline(self, seqid, iprot, oprot):
        ...
        result = ReadHomeTimeline_result()
        try:
            result.success = self._handler.ReadHomeTimeline(args.flow, args.timestamp2, args.edge, args.req_id, args.user_id, args.start, args.stop, args.carrier)
    ...
    def process_WriteHomeTimeline(self, seqid, iprot, oprot):
        ...
        result = WriteHomeTimeline_result()
        try:
            self._handler.WriteHomeTimeline(args.flow, args.timestamp2, args.edge, args.req_id, args.post_id, args.user_id, args.timestamp, args.user_mentions_id, args.carrier)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except ServiceException as se:
...
class WriteHomeTimeline_args(object):
    ...
    def __init__(self, flow=None, timestamp2=None, edge=None, req_id=None, post_id=None, user_id=None, timestamp=None, user_mentions_id=None, carrier=None,):
        self.flow = flow
        self.timestamp2 = timestamp2
        self.edge = edge
        self.req_id = req_id
...
WriteHomeTimeline_args.thrift_spec = (
    ...
    (8, TType.LIST, 'user_mentions_id', (TType.I64, None, False), None, ),  # 8
