...
class Iface(object):
    ...
    def ComposeCreatorWithUserId(self, flow, timestamp, edge, req_id, user_id, username, carrier):
        """
        Parameters:
         - flow
         - timestamp
...
class Client(Iface):
    ...
    def send_ComposeCreatorWithUserId(self, flow, timestamp, edge, req_id, user_id, username, carrier):
...
class Processor(Iface, TProcessor):
    ...
    def process_ComposeCreatorWithUserId(self, seqid, iprot, oprot):
        ...
        result = ComposeCreatorWithUserId_result()
        try:
            result.success = self._handler.ComposeCreatorWithUserId(args.flow, args.timestamp, args.edge, args.req_id, args.user_id, args.username, args.carrier)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except ServiceException as se:
...
class ComposeCreatorWithUserId_args(object):
    ...
    def __init__(self, flow=None, timestamp=None, edge=None, req_id=None, user_id=None, username=None, carrier=None,):
        self.flow = flow
