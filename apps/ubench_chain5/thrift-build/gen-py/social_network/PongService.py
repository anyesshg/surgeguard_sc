...
class Iface(object):
    def Pong(self, flow, timestamp, level, req_id):
        """
        Parameters:
         - flow
         - timestamp
...
class Client(Iface):
    ...
    def send_Pong(self, flow, timestamp, level, req_id):
...
class Processor(Iface, TProcessor):
    ...
    def process_Pong(self, seqid, iprot, oprot):
        ...
        result = Pong_result()
        try:
            self._handler.Pong(args.flow, args.timestamp, args.level, args.req_id)
