...
Ping0ServiceClient = __TObject.new(__TClient, {
  __type = 'Ping0ServiceClient'
})

function Ping0ServiceClient:Ping(flow, timestamp, level, req_id)
  self:send_Ping(flow, timestamp, level, req_id)
  self:recv_Ping(flow, timestamp, level, req_id)
end

function Ping0ServiceClient:send_Ping(flow, timestamp, level, req_id)
...
function Ping0ServiceClient:recv_Ping(flow, timestamp, level, req_id)
...
Ping0ServiceIface = __TObject:new{
  __type = 'Ping0ServiceIface'
}


Ping0ServiceProcessor = __TObject.new(__TProcessor
, {
 __type = 'Ping0ServiceProcessor'
})

function Ping0ServiceProcessor:process(iprot, oprot, server_ctx)
...
function Ping0ServiceProcessor:process_Ping(seqid, iprot, oprot, server_ctx)
  local args = Ping_args:new{}
...
return Ping0ServiceClient, Ping0ServiceProcessor