...
Ping5ServiceClient = __TObject.new(__TClient, {
  __type = 'Ping5ServiceClient'
})

function Ping5ServiceClient:Ping(flow, timestamp, level, req_id)
  self:send_Ping(flow, timestamp, level, req_id)
  self:recv_Ping(flow, timestamp, level, req_id)
end

function Ping5ServiceClient:send_Ping(flow, timestamp, level, req_id)
...
function Ping5ServiceClient:recv_Ping(flow, timestamp, level, req_id)
...
Ping5ServiceIface = __TObject:new{
  __type = 'Ping5ServiceIface'
}


Ping5ServiceProcessor = __TObject.new(__TProcessor
, {
 __type = 'Ping5ServiceProcessor'
})

function Ping5ServiceProcessor:process(iprot, oprot, server_ctx)
...
function Ping5ServiceProcessor:process_Ping(seqid, iprot, oprot, server_ctx)
  local args = Ping_args:new{}
...
return Ping5ServiceClient, Ping5ServiceProcessor