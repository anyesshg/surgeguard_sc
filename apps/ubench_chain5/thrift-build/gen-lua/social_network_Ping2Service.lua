...
Ping2ServiceClient = __TObject.new(__TClient, {
  __type = 'Ping2ServiceClient'
})

function Ping2ServiceClient:Ping(flow, timestamp, level, req_id)
  self:send_Ping(flow, timestamp, level, req_id)
  self:recv_Ping(flow, timestamp, level, req_id)
end

function Ping2ServiceClient:send_Ping(flow, timestamp, level, req_id)
...
function Ping2ServiceClient:recv_Ping(flow, timestamp, level, req_id)
...
Ping2ServiceIface = __TObject:new{
  __type = 'Ping2ServiceIface'
}


Ping2ServiceProcessor = __TObject.new(__TProcessor
, {
 __type = 'Ping2ServiceProcessor'
})

function Ping2ServiceProcessor:process(iprot, oprot, server_ctx)
...
function Ping2ServiceProcessor:process_Ping(seqid, iprot, oprot, server_ctx)
  local args = Ping_args:new{}
...
return Ping2ServiceClient, Ping2ServiceProcessor