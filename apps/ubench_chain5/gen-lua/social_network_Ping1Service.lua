...
Ping1ServiceClient = __TObject.new(__TClient, {
  __type = 'Ping1ServiceClient'
})

function Ping1ServiceClient:Ping(flow, timestamp, level, req_id)
  self:send_Ping(flow, timestamp, level, req_id)
  self:recv_Ping(flow, timestamp, level, req_id)
end

function Ping1ServiceClient:send_Ping(flow, timestamp, level, req_id)
...
function Ping1ServiceClient:recv_Ping(flow, timestamp, level, req_id)
...
Ping1ServiceIface = __TObject:new{
  __type = 'Ping1ServiceIface'
}


Ping1ServiceProcessor = __TObject.new(__TProcessor
, {
 __type = 'Ping1ServiceProcessor'
})

function Ping1ServiceProcessor:process(iprot, oprot, server_ctx)
...
function Ping1ServiceProcessor:process_Ping(seqid, iprot, oprot, server_ctx)
  local args = Ping_args:new{}
...
return Ping1ServiceClient, Ping1ServiceProcessor