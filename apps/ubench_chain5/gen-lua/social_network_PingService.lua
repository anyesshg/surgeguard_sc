...
PingServiceClient = __TObject.new(__TClient, {
  __type = 'PingServiceClient'
})

function PingServiceClient:Ping(flow, timestamp, level, req_id)
  self:send_Ping(flow, timestamp, level, req_id)
  self:recv_Ping(flow, timestamp, level, req_id)
end

function PingServiceClient:send_Ping(flow, timestamp, level, req_id)
...
function PingServiceClient:recv_Ping(flow, timestamp, level, req_id)
...
PingServiceIface = __TObject:new{
  __type = 'PingServiceIface'
}


PingServiceProcessor = __TObject.new(__TProcessor
, {
 __type = 'PingServiceProcessor'
})

function PingServiceProcessor:process(iprot, oprot, server_ctx)
...
function PingServiceProcessor:process_Ping(seqid, iprot, oprot, server_ctx)
  local args = Ping_args:new{}
...
return PingServiceClient, PingServiceProcessor